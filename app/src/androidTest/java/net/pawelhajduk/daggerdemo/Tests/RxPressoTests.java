...
//    }
    ...
    @Test
    public void goAndLoadTest() throws Exception {
...
//    @Test
//    public void goAndLoadWithWaitTest() throws Exception {
//        onView(withId(R.id.goToRepositoriesListWithWAit)).perform(click());
//        Requests.listRepos("FutureProcessing", Mocks.MOCKED_LIST);
//        checkElements();
//    }

    @Test
    public void loadAndGoTest() throws Exception {
        onView(withId(R.id.loadDataThenGo)).perform(click());
        Requests.listRepos("FutureProcessing", Mocks.MOCKED_LIST);
        checkElements();
    }
